      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <a href="" class="flex ms-2 md:me-24">
            ...
            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">DocDash</span>
          </a>
        </div>
        ...
        <ul class="flex flex-col py-4 space-y-1">
          ...
          <li>
            <router-link to="/admin/meneuser">
              <a
                ...
                <span class="ml-2 text-sm tracking-wide truncate">Manajement Users</span>
                <!-- <span
          ...
          <div class="relative transition">
            ...
            <svg xmlns="http://www.w3.org/2000/svg"
              class="absolute right-0 top-4 ml-auto mr-5 h-4 text-gray-600 transition peer-checked:rotate-180 peer-hover:text-blue-600"
