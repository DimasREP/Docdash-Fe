...
export default {
  methods: {
    submitForm() {
      // Logika untuk memproses formulir login dan autentikasi pengguna
      // Setelah autentikasi berhasil, navigasikan pengguna ke halaman home
      this.$router.push("/home"); // Ganti '/home' dengan jalur sesuai dengan konfigurasi routing Anda
    },
  },
};
</script>
