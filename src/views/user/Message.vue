<template>
  <div class="sm:p-10 my-auto mt-10 ml-16 mr-16">
    <section class="mx-auto max-w-screen-xl md:rounded-md md:border md:shadow-lg">
      <div class="grid grid-cols-4 text-gray-800 lg:grid-cols-3">
        <div
          ...
          <h2 class="mb-8 text-2xl font-black">Kontak</h2>
          <ul>
            <li class="mb-6 flex items-start text-left">
              ...
              <div>
                <a class="cursor-pointer font-serif text-base md:text-lg" href="#">docdash@gmail.com</a>
            ...
            <li class="my-6 flex items-center text-left">
              ...
              <div>
                <a class="cursor-pointer font-serif text-base md:text-lg" href="#">docdash.real</a>
        ...
        <div class="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
          <h2 class="mb-8 text-2xl font-black">Kirim Masukan Anda</h2>
          <p class="mt-2 mb-4 font-sans text-sm tracking-normal"></p>
          <form action="">
